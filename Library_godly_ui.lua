...
local Library = {
    ...
    IsLightTheme = false,
    Scheme = {
        BackgroundColor = Color3.fromRGB(12, 14, 15),
        MainColor = Color3.fromRGB(20, 23, 24),
        AccentColor = Color3.fromRGB(55, 220, 180),
        OutlineColor = Color3.fromRGB(34, 40, 41),
...
local SWITCH_ON_GRADIENT_FROM = Color3.fromRGB(80, 245, 205)
local SWITCH_ON_GRADIENT_TO = Color3.fromRGB(190, 255, 238)
...
local SLIDER_BAR_HEIGHT = 12
local SLIDER_BALL_SIZE = 14
local SLIDER_BALL_SIZE_ACTIVE = 18
...
local SLIDER_TRACK_GRADIENT_FROM = Color3.fromRGB(95, 245, 210)
local SLIDER_TRACK_GRADIENT_TO = Color3.fromRGB(45, 80, 72)
    ...
    function Window:AddTab(...)
        ...
        function Tab:AddGroupbox(Info)
            ...
            do
                ...
                GroupboxLine.BackgroundColor3 = Library.Scheme.OutlineColor

                --// Small accent rail: cosmetic only, no public API/state changes.
                ...
                Library:AddToRegistry(GroupboxAccent, { BackgroundColor3 = "AccentColor" })
