...
local Library = {
    ...
    IsLightTheme = false,
    Scheme = {
        BackgroundColor = Color3.fromRGB(11, 12, 14),
        MainColor = Color3.fromRGB(19, 21, 23),
        AccentColor = Color3.fromRGB(45, 218, 178),
        OutlineColor = Color3.fromRGB(38, 42, 44),
        FontColor = Color3.fromRGB(224, 228, 230),
